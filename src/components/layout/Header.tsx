      ...
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden sm:flex items-center gap-5 text-sm">
            ...
            <Link href="/marketplace" className="text-neutral-300 hover:text-white transition">
              Marketplace
            </Link>
            <Link href="/event" className="text-neutral-300 hover:text-white transition">
              Events
            </Link>
            <Link href="/dojo" className="text-neutral-300 hover:text-white transition">
              Dojo
            </Link>
            <Link href="/qa" className="text-neutral-300 hover:text-white transition">
              Q&amp;A
            </Link>
            {session?.user && (
